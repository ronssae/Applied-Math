...
public class Enemy : MonoBehaviour
{
    ...
    bool SeePlayer()
    {
        ...
        {
            Debug.DrawRay(transform.position, transform.up * viewDistance,
            Color.yellow, 0);
            Debug.DrawRay(transform.position, dir.normalized * viewDistance,
            Color.yellow, 0);
    ...
    void Update()
    {
        ...
        else
        {
            ...
            transform.rotation = Quaternion.Lerp(transform.rotation, p,
            Time.deltaTime * 5.0f);
            transform.position += transform.up * 10.0f * Time.deltaTime;
        }
        Debug.DrawRay(transform.position, transform.up * viewDistance, seen ?
